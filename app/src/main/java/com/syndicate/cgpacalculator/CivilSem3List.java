...
public class CivilSem3List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_civil_sem3_list);
...
t1.setOnClickListener(new View.OnClickListener() {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CivilSem3List.this,CivilSemList.class);
...
//                Toast.makeText(CseSem1List.this,"GPA Copied",Toast.LENGTH_SHORT).show();
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ClipData clipData = ClipData.newPlainText("text",result.getText().toString());
                clipboardManager.setPrimaryClip(clipData);
                Toast.makeText(CivilSem3List.this,"GPA Copied",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate()
    {
        ...
        float res = ((float)val1*4+(float)val2*3+(float)val3*3+(float)val4*4+(float)val5*4+(float)val6*4+(float)val7*2+(float)val8*2+(float)val9*2)/28;
    ...
    public void write(){
        ...
        try{
            ...
            Toast.makeText(CivilSem3List.this,"Added To CGPA ",Toast.LENGTH_SHORT).show();
