...
public class CivilSem5List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_civil_sem5_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CivilSem5List.this,CivilSemList.class);
...
//                Toast.makeText(CseSem1List.this,"GPA Copied",Toast.LENGTH_SHORT).show();
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ClipData clipData = ClipData.newPlainText("text",result.getText().toString());
                clipboardManager.setPrimaryClip(clipData);
                Toast.makeText(CivilSem5List.this,"GPA Copied",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate()
    {
        ...
        float res = ((float)val1*4+(float)val2*4+(float)val3*4+(float)val4*4+(float)val5*4+(float)val6*3+(float)val7*2+(float)val8*2+(float)val9*2+(float)val10*2)/31;
    ...
    public void write(){
        ...
        try{
            ...
            Toast.makeText(CivilSem5List.this,"Added To CGPA ",Toast.LENGTH_SHORT).show();
