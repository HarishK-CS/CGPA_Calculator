...
public class CivilSem6List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_civil_sem6_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CivilSem6List.this,CivilSemList.class);
...
//                Toast.makeText(CseSem1List.this,"GPA Copied",Toast.LENGTH_SHORT).show();
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ClipData clipData = ClipData.newPlainText("text",result.getText().toString());
                clipboardManager.setPrimaryClip(clipData);
                Toast.makeText(CivilSem6List.this,"GPA Copied",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void write(){
        ...
        try{
            FileOutputStream fileOutputStream = openFileOutput("sem6.txt",MODE_PRIVATE);
            fileOutputStream.write(textToSave.getBytes());
            fileOutputStream.close();
            Toast.makeText(CivilSem6List.this,"Added To CGPA ",Toast.LENGTH_SHORT).show();
