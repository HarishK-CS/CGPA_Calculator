...
public class CivilSem8List  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_civil_sem8_list);
       ...
       s = findViewById(R.id.S);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CivilSem8List.this,CivilSemList.class);
...
//                Toast.makeText(CseSem1List.this,"GPA Copied",Toast.LENGTH_SHORT).show();
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ClipData clipData = ClipData.newPlainText("text",result.getText().toString());
                clipboardManager.setPrimaryClip(clipData);
                Toast.makeText(CivilSem8List.this,"GPA Copied",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate()
    {
        ...
        float res = ((float)val1*3+(float)val2*3+(float)val3*3+(float)val4*3+(float)val5*3+(float)val6*2+(float)val7*2+(float)val8*1+(float)val9*6)/26;
    ...
    public void write(){
        ...
        try{
            ...
            Toast.makeText(CivilSem8List.this,"Added To CGPA ",Toast.LENGTH_SHORT).show();
