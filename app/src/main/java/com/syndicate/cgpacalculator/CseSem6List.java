...
public class CseSem6List extends AppCompatActivity {
        ...
        t10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                back.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(CseSem6List.this, CseSemList.class);
                ...
                cpyIcon.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Toast.makeText(CseSem6List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            public void write() {
                ...
                try {
                    ...
                    Toast.makeText(CseSem6List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
