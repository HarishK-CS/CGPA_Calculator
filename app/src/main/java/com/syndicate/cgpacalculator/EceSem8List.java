...
public class EceSem8List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ece_sem8_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(EceSem8List.this,EceSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(EceSem8List.this,"GPA Copied",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate()
    {
        ...
        float res = ((float)val1*1+(float)val2*4+(float)val3*4+(float)val4*4+(float)val5*2+(float)val6*1+(float)val7*8)/24;
...
//    }
    ...
    public void write(){
        ...
        try{
            ...
            Toast.makeText(EceSem8List.this,"Added To CGPA ",Toast.LENGTH_SHORT).show();
