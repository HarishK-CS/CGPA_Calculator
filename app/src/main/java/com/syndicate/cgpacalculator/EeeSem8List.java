...
public class EeeSem8List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eee_sem8_list);
...
//        setupSemInputs();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(EeeSem8List.this,EeeSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(EeeSem8List.this,"GPA Copied",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate()
    {
        ...
        float res = ((float)val1*4+(float)val2*1+(float)val3*4+(float)val4*4+(float)val5*8+(float)val6*1)/22;
...
//    }
    ...
    public void write(){
        ...
        try{
            ...
            Toast.makeText(EeeSem8List.this,"Added To CGPA ",Toast.LENGTH_SHORT).show();
