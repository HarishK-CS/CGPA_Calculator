...
public class MechSem3List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mech_sem3_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MechSem3List.this,MechSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MechSem3List.this,"GPA Copied",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void write(){
        ...
        try{
            ...
            Toast.makeText(MechSem3List.this,"Added To CGPA ",Toast.LENGTH_SHORT).show();
